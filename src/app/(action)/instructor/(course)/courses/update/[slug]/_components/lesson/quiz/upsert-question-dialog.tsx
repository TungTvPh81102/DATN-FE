...
export const UpsertQuestionDialog = ({
  isOpen,
  quizId,
  onOpenChange,
  question,
  ...
  useEffect(() => {
    if (question) {
      const options = question.answers.map((opt) => ({
        answer: opt.answer,
  ...
  useEffect(() => {
    if (answerType === AnswerType.SINGLE_CHOICE) {
    ...
    <>
      ...
      >
        <DialogContent className="w-full lg:max-w-4xl xl:max-w-7xl">
          <DialogHeader>
            <DialogTitle>
              {isDraftOrRejected ? (question?.id ? 'Sửa' : 'Tạo') : 'Thông tin'}{' '}
              câu hỏi trắc nghiệm
            </DialogTitle>
            <DialogDescription>
                        ...
                        <FormControl>
                          ...
                          >
                            <FormItem className="flex items-center space-x-3 space-y-0">
                              <FormControl>
                                <RadioGroupItem
                                  value={AnswerType.SINGLE_CHOICE}
                                />
                              </FormControl>
                                    ...
                                    <FormItem>
                                      <FormControl>
                                        <RadioGroup
                                          ...
                                          disabled={field.disabled || dragMode}
                          ...
                          <FileCard
                            file={
                              image instanceof File
                                ? image
                                : ({
                                    name: question?.question || 'Hình ảnh',
